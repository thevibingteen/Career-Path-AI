            ...
            <div class="md:w-1/2 p-8">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" value="${state.userData.name}" oninput="updateUserData('name', event)" class="w-full px-4 py-3 border ${state.errors.name ? 'error' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600" placeholder="John Doe">
                    ...
                    <div>
                        ...
                        <input type="email" value="${state.userData.email}" oninput="updateUserData('email', event)" class="w-full px-4 py-3 border ${state.errors.email ? 'error' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600" placeholder="john@example.com">
                        ${state.errors.email ? `<p class="error-message">${state.errors.email}</p>` : ''}
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Your Current Skills*</label>
                        <textarea oninput="updateUserData('skills', event)" class="w-full px-4 py-3 border ${state.errors.skills ? 'error' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600" rows="3" placeholder="Python, JavaScript, UI Design, Project Management...">${state.userData.skills}</textarea>
                    ...
                    <div>
                        ...
                        <select onchange="updateUserData('employmentStatus', event)" class="w-full px-4 py-3 border ${state.errors.employmentStatus ? 'error' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600">
                    ...
                    <div>
                        ...
                        <select onchange="updateUserData('experience', event)" class="w-full px-4 py-3 border ${state.errors.experience ? 'error' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600">
...
function renderInterestsStep() {
    const interests = ['Software Development', 'Data Science', 'UI/UX Design', 'Cloud Computing', 'Digital Marketing', 'DevOps', 'Cybersecurity', 'AI/ML Engineering'];
    ...
    app.innerHTML = `
        <div class="md:flex">
            <div class="md:w-1/2 p-8">
                ...
                <div class="space-y-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">What are you passionate about? (Select 2-3)*</label>
            ...
            <div class="md:w-1/2 p-8">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea oninput="updateUserData('goals', event)" class="w-full px-4 py-3 border ${state.errors.goals ? 'error' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600" rows="3" placeholder="I want to transition to a tech career within 12 months...">${state.userData.goals}</textarea>
                        ${state.errors.goals ? `<p class="error-message">${state.errors.goals}</p>` : ''}
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Constraints (time, location, etc.)</label>
                        <textarea oninput="updateUserData('constraints', event)" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600" rows="2" placeholder="I can study 10 hours per week...">${state.userData.constraints}</textarea>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Target Salary Range (INR)*</label>
                        <select onchange="updateUserData('salaryRange', event)" class="w-full px-4 py-3 border ${state.errors.salaryRange ? 'error' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600">
        ...
        <div class="p-8">
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8">
                ${state.topCareers.map((career, index) => `
                    <div class="career-path-card bg-white dark:bg-gray-800 p-5 rounded-lg shadow-md">
...
function showCareerDetailsInModal(careerName) {
    ...
    modalContent.innerHTML = `
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2">
                    ${career.freelancingPlatforms.map(platform => `
                        <span class="bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 text-xs font-medium px-2 py-1 rounded">${platform}</span>
                    `).join('')}
                </div>
            </div>
            ` : ''}
            ...
            <div>
                <h3 class="font-semibold text-lg mb-2 dark:text-white">Companies Hiring</h3>
                <div class="flex flex-wrap gap-2">
                    ${career.companies.map(company => `
                        <span class="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-xs font-medium px-2 py-1 rounded">${company}</span>
                    `).join('')}
                </div>
            </div>
            ` : ''}
